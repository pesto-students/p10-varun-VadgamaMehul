...
// s.peek()
console.log(s.size);
// deleteMiddelElementOfStack(s, 0, s.size);
AddElemetInBottom(s,s.size,0);
s.printStack();
console.log(s.size);

function deleteMiddelElementOfStack(stack, count, size) {
  ...
  deleteMiddelElementOfStack(stack, count + 1, size);
